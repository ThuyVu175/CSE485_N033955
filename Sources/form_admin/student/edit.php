...
?>
<br><br>
<h2 style="padding-left: 50px;">Sửa Thông Tin Học Viên</h2>
<form style="padding-left: 100px;margin-top:20px;" action="XuLyEdit.php" method="post">
    <input type="hidden" name="ID" value="<?php echo $row['ID']?>">
    <table>
        <tr>
            <td WIDTH = "200px;">Sửa ID tài khoản Học Viên:</td>
            <td><input style="margin-left: 30px;" type="text" name="accountID" value="<?php echo $row['accountID'];?>"></td>
        </tr>
        <tr>
            <td>Sửa tên Học Viên:</td>
            <td><input style="margin-left: 30px;margin-top:5px;" type="text" name="name" value="<?php echo $row['name'];?>"></td>
        </tr>
        <tr>
            <td>Sửa học phí đã nộp:</td>
            <td><input style="margin-left: 30px;margin-top:5px;" type="text" name="paid" value="<?php echo $row['paid'];?>"></td>
        </tr>
        <tr>
            <td>Sửa học phí còn nợ:</td>
            <td> <input style="margin-left: 30px;margin-top:5px;" type="text" name="owed" value="<?php echo $row['owed'];?>"></td>
        </tr>
        <tr>
            <td> Sửa tuổi:</td>
        ...
        <tr>
            <td>Sửa giới tính:</td>
            <td> <input style="margin-left: 30px;margin-top:5px;" type="text" name="sexual" value="<?php echo $row['sexual'];?>"></td>
        </tr>
    </table>
    <br>
